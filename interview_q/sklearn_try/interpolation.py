...
def get_results(dataset):
    ...
    full_scores = cross_val_score(estimator, X_full, y_full, scoring='neg_mean_squared_error', cv=5)
    ...
    estimator = RandomForestRegressor(random_state=0, n_estimators=100)
    zero_impute_scores = cross_val_score(estimator, X_missing, y_missing, scoring='neg_mean_squared_error', cv=5)
    ...
    mean_impute_scores = cross_val_score(estimator, X_missing, y_missing, scoring='neg_mean_squared_error', cv=5)
